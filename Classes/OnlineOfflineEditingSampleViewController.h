...
@interface OnlineOfflineEditingSampleViewController : UIViewController<AGSLayerDelegate,AGSMapViewTouchDelegate, AGSMapViewCalloutDelegate, AGSCalloutDelegate, AGSInfoTemplateDelegate, OnlineOfflineDelegate,UIAlertViewDelegate> {
	AGSMapView *_mapView;
